"""
Django settings for teveclub_web project.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-change-this-in-production-teveclub-2025')
...
ROOT_URLCONF = 'teveclub_web.urls'
...
WSGI_APPLICATION = 'teveclub_web.wsgi.application'
